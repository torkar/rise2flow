...
2. Daily trends modeled with Gaussian Processes (results in Sect. \@ref(daily)). We've also shown conditional effects of `gender` since it is the main driver for differences we're seeing.
