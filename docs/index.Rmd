...
Sampled good but we needed to run the chains longer to fin the typical set.

```{r}
conditional_effects(m_daily)
```

Weak positive trend, but nothing siginificant really.
...
# TODO: 
# * Use IPIP as preds for exit instruments,
#   * MAAS
#   * SPANE
#   * PWB
#   * PST
...
m_maas_entry <- brm(bf1, family = cumulative, data = d2, prior = p, 
                    threads = threading(2))
