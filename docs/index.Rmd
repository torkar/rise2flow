...
```{r load, echo=TRUE}
entry <- read.xlsx(here("data/E1/R2F Quant Comp Data Entry.xlsx")) # all instruments
exit <- read.xlsx(here("data/E1/R2F Quant Comp Data Exit.xlsx")) # same here
weekly <- read.xlsx(here("data/E1/R2F Quant Weekly.xlsx"), detectDates = T)
pers <- read.xlsx(here("data/E1/R2F Pers Data.xlsx")) # personal data
daily <- read.xlsx(here("data/E1/R2F Daily.xlsx"), detectDates = T)
```
