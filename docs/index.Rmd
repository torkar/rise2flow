...
weekly$Date_i <- as.numeric(weekly$Date)
weekly <- weekly[complete.cases(weekly), ]
...
Let's redo this bu for the `daily` dataset.

```{r, cache = TRUE}
daily$ID <- as.factor(daily$ID)
daily$date_s <- as.numeric(daily$date)

p <- get_prior(resp ~ 1 + gp(date_s) + (1| ID), data = daily, family = cumulative)
p$prior[1] <- "normal(0,5)"
p$prior[c(13,16)] <- "weibull(2,1)"

m_daily <- brm(resp ~ 1 + gp(date_s) + (1| ID), 
               data = daily, 
               family = cumulative,
               prior = p,
               control = list(adapt_delta=0.95), 
               iter = 8e3, threads = threading(2))
```

Sampled good but we needed to run the chains longer to find the typical set.

```{r}
conditional_effects(m_daily)
```

Weak positive trend, but nothing significant really.
...
# incl. IPIP as preds for exit instruments,
#   * MAAS
#   * SPANE
#   * PWB
#   * PST
...
# Create new df with exit and pers+IPIP data. Use d but keep only rows where t=1 
# (i.e., exit survey)
d2 <- d[d$t == 1, ]
...
bf1 <- bf(mvbind(MAASQ116,
                 ...
                 MAASQ1416,
                 MAASQ1516) ~ 
              1 + Age + Gender01 + Occupation + Living14 + mo(IPIP115) + mo(IPIP215) + mo(IPIP315) + mo(IPIP415) + mo(IPIP515) + mo(IPIP615) + mo(IPIP715) + mo(IPIP815) + mo(IPIP915) + mo(IPIP1015) + mo(IPIP1115) + mo(IPIP1215) + mo(IPIP1315) + mo(IPIP1415) + mo(IPIP1515) + mo(IPIP1615) + mo(IPIP1715) + mo(IPIP1815) + mo(IPIP1915) + mo(IPIP2015) + (1 |c| ID))

p <- get_prior(bf1, family = cumulative, data = d2)
p$prior[1] <- "normal(0,1)"
p$prior[2] <- "lkj(2)"
p$prior[4] <- "normal(0,5)"

m_maas_exit <- brm(bf1, family = cumulative, data = d2, prior = p, 
...
m_spane_exit <- brm(bf1, family = cumulative, data = d2, prior = p, 
                    threads = threading(2), refresh = 0)
...
m_pwb_exit <- brm(bf1, family = cumulative, data = d2, prior = p, 
                    threads = threading(2), refresh = 0)
...
p <- get_prior(bf1, family = bernoulli, data = d2)
p$prior[1] <- "normal(0,1)"
p$prior[2] <- "lkj(2)"
p$prior[4] <- "normal(0,5)"

m_pst_exit <- brm(bf1, family = bernoulli, data = d2, prior = p, refresh = 0)

bf1 <- bf(mvbind(#SEQ114, # binary outcome
                 #SEQ214, # -"-
                 SEQ314,
                 #SEQ414,
                 SEQ514,
...
m_se_exit <- brm(bf1, family = cumulative, data = d2, prior = p, 
                 threads = threading(2), refresh = 0)

```

```{r}
# * Use IPIP as preds with weekly
# and compare with our five GP models
# Let's use GP to model over time, it'll be the same priors for all

# Combine weekly with pers and IPIP data

dw <- inner_join(weekly, pers, by = "ID")
dw <- inner_join(dw, ipip, by = "ID")

dw$Date_i <- as.numeric(dw$Date)
dw <- dw[complete.cases(dw),] # 184 rows

p <- get_prior(WQ1_1_6 ~ gp(Date_i) +  1 + Age + Gender01 + Occupation + 
                 Living14 + mo(IPIP115) + mo(IPIP215) + mo(IPIP315) + 
                 mo(IPIP415) + mo(IPIP515) + mo(IPIP615) + mo(IPIP715) + 
                 mo(IPIP815) + mo(IPIP915) + mo(IPIP1015) + mo(IPIP1115) +
                 mo(IPIP1215) + mo(IPIP1315) + mo(IPIP1415) + mo(IPIP1515) +
                 mo(IPIP1615) + mo(IPIP1715) + mo(IPIP1815) + mo(IPIP1915) +
                 mo(IPIP2015) + (1 | ID), 
               data = dw, 
               family = cumulative())

p$prior[1] <- "normal(0,1)"
p$prior[c(28)] <- "normal(0,5)"
p$prior[c(35)] <- "weibull(2,1)"
p$prior[c(40:59)] <- "dirichlet(2)"

WQ1gp_ipip <- brm(WQ1_1_6 ~ gp(Date_i) +  1 + Age + Gender01 + Occupation + 
                 Living14 + mo(IPIP115) + mo(IPIP215) + mo(IPIP315) + 
                 mo(IPIP415) + mo(IPIP515) + mo(IPIP615) + mo(IPIP715) + 
                 mo(IPIP815) + mo(IPIP915) + mo(IPIP1015) + mo(IPIP1115) +
                 mo(IPIP1215) + mo(IPIP1315) + mo(IPIP1415) + mo(IPIP1515) +
...
WQ2gp_ipip <- brm(WQ2_1_6 ~ gp(Date_i) +  1 + Age + Gender01 + Occupation + 
                 Living14 + mo(IPIP115) + mo(IPIP215) + mo(IPIP315) + 
                 mo(IPIP415) + mo(IPIP515) + mo(IPIP615) + mo(IPIP715) + 
                 mo(IPIP815) + mo(IPIP915) + mo(IPIP1015) + mo(IPIP1115) +
                 mo(IPIP1215) + mo(IPIP1315) + mo(IPIP1415) + mo(IPIP1515) +
...
WQ3gp_ipip <- brm(WQ3_1_6 ~ gp(Date_i) +  1 + Age + Gender01 + Occupation + 
                 Living14 + mo(IPIP115) + mo(IPIP215) + mo(IPIP315) + 
                 mo(IPIP415) + mo(IPIP515) + mo(IPIP615) + mo(IPIP715) + 
                 mo(IPIP815) + mo(IPIP915) + mo(IPIP1015) + mo(IPIP1115) +
                 mo(IPIP1215) + mo(IPIP1315) + mo(IPIP1415) + mo(IPIP1515) +
...
WQ4gp_ipip <- brm(WQ4_1_6 ~ gp(Date_i) +  1 + Age + Gender01 + Occupation + 
                 Living14 + mo(IPIP115) + mo(IPIP215) + mo(IPIP315) + 
                 mo(IPIP415) + mo(IPIP515) + mo(IPIP615) + mo(IPIP715) + 
                 mo(IPIP815) + mo(IPIP915) + mo(IPIP1015) + mo(IPIP1115) +
                 mo(IPIP1215) + mo(IPIP1315) + mo(IPIP1415) + mo(IPIP1515) +
...
WQ5gp_ipip <- brm(WQ5_1_6 ~ gp(Date_i) +  1 + Age + Gender01 + Occupation + 
                 Living14 + mo(IPIP115) + mo(IPIP215) + mo(IPIP315) + 
                 mo(IPIP415) + mo(IPIP515) + mo(IPIP615) + mo(IPIP715) + 
                 mo(IPIP815) + mo(IPIP915) + mo(IPIP1015) + mo(IPIP1115) +
                 mo(IPIP1215) + mo(IPIP1315) + mo(IPIP1415) + mo(IPIP1515) +
